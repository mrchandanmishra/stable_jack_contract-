...
import type {
  HarvestableTreasury,
  HarvestableTreasuryInterface,
} from "../../contracts/HarvestableTreasury";
...
export class HarvestableTreasury__factory {
  static readonly abi = _abi;
  static createInterface(): HarvestableTreasuryInterface {
    return new Interface(_abi) as HarvestableTreasuryInterface;
  }
  static connect(
    address: string,
    ...
    return new Contract(
      ...
      _abi,
      runner
    ) as unknown as HarvestableTreasury;
  }
}
