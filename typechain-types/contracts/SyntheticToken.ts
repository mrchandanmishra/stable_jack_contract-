...
export interface SyntheticTokenInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "allowance"
      | "approve"
...
export interface SyntheticToken extends BaseContract {
  connect(runner?: ContractRunner | null): SyntheticToken;
  ...
  initialize: TypedContractMethod<
    [_treasury: AddressLike, _name: string, _symbol: string],
    [void],
    "nonpayable"
  >;
